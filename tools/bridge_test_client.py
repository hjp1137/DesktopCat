    ...
    while client.running:
        try:
            ...
            if c in ["q", "quit", "exit"]: break
                ...
                print("Commands: ping, status, jump, stop, left, right, run_left, run_right, sit, sleep, wake, auto, look <x> <y>, move <x> <y>, clear, stress [sec], f8 (windows), f9 (surfaces), f10 (physics), f11 (ui), bad_json, unknown, snapshot, quit")
